...
public class DeleteContactInAddressBook {
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch (choice) {
			// case1 is used to add new contact details.
			case 1:
				...
				break;
			// Case2 is used to display contact details.
			case 2:
				System.out.println(arraylist);
				break;

			// case3 is used to edit existing contact details
			case 3:
				boolean found = false;
			...
			// case4 is used to delete contact details.
			case 4:
				found = false;
				System.out.println("Enter first name of the person for delete ");
				firstNameNew = reader.nextLine();
				System.out.println("____________________________________");
				Iterator<ContactDetails> iterator = arraylist.iterator(); // this is used for iteration
				while (iterator.hasNext()) {
					contactdetails = iterator.next();
					if (contactdetails.getFirstName().equals(firstNameNew)) {
						iterator.remove(); // remove method used to delete the contact details.
						found = true;
					}
				}
				System.out.println("____________________________________");
